...
def logo():
	...
	print("  \033[0;91m___ ___ YyyyyyyyY__ ___ ___ \n \033[0;91m/ __|_ _|  TT | _ ) __| \033[0;96mAU\033[0;97m : Mark Cornel\n\033[0;97m [][][][][][][][][][]033[0;91mFB\033[0;97m : FB.ME/GAAAARZXD\n\033[0;97m |---------|∆|V2 \033[0;93mGH\033[0;97m : Gupta Shakel")
...
def bot_komen():
    ...
    kom = ("GW PAKE SC LU BANG @[100015073506062:0] ❤️🙂\nhttps://www.facebook.com/profile.php?id=100046218699200") 

    kom2 = ("KEREN BANG @[100015073506062:0] 🙂❤️\nhttps://www.facebook.com/profile.php?id=100046218699200") 
...
def tokenz():
	...
	try:
		...
		print("\n \033[0;97m[\033[0;93m*\033[0;97m] How To Get Token : https://Timmytedy.blogspot.com")
...
def menu():
	...
	print(" \033[0;97m[\033[0;96m+\033[0;91m] Active User: %s"%(nama))

	print(" \033[0;97m[\033[0;96m+\033[0;92m] IP Address  : %s"%(ip))
